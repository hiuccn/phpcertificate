...
// require_once('WxqqJumpWxqqJump.php');
...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0}
        ...
        .top-bar-guidance{font-size:15px;color:#fff;height:70%;line-height:1.8;padding-left:20px;padding-top:20px;background:url(https://cer.ihyys.cn/WxqqJump/banner.png) center top/contain no-repeat}
...
<div class="top-bar-guidance">
    <p>点击右上角<img src="https://cer.ihyys.cn/WxqqJump/3dian.png" class="icon-safari">在 浏览器 打开</p>
    <p>苹果设备<img src="https://cer.ihyys.cn/WxqqJump/iphone.png" class="icon-safari">安卓设备<img src="https://cer.ihyys.cn/WxqqJump/android.png" class="icon-safari">↗↗↗</p>
</div>
...
<p><br/></p>
<div class="app-download-tip">
    <span class="guidance-desc">点击右上角<img src="https://cer.ihyys.cn/WxqqJump/3dian.png" class="icon-sgd"> or 复制网址自行打开</span>
</div>
